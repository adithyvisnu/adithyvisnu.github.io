...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=00FF88&center=true&vCenter=true&width=500&lines=Backend+Software+Engineer;TypeScript+%26+Node.js+Specialist;Distributed+Systems+Enthusiast;Building+Scalable+APIs+%26+Services)](https://git.io/typing-svg)
...
const developer = {
  ...
  focus:    ["APIs", "Distributed Systems", "Microservices"],
  approach: "Clean architecture, observable systems, scalable design",
...
> Ordered by familiarity — most to least
...
Things I'm actively leveling up on:

- **System Design** — CQRS, Event Sourcing, Saga patterns on top of my Kafka experience
- **Go deeper on Golang** — goroutines, channels, gRPC for high-performance services
- **Kubernetes** — owning the full container orchestration layer (K8s, Helm)
- **Observability** — extending ELK with Prometheus + Grafana + OpenTelemetry
- **Security Engineering** — OAuth2/OIDC, Vault, OWASP hardening
- **API Design** — gRPC, GraphQL, OpenAPI spec-first workflows
